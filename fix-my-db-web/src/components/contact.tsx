        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="message"
                    placeholder="Tell us about your database issues..."
          ...
          <div className="space-y-8">
            ...
            <div className="bg-orange-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">Database down? We offer 24/7 emergency support for critical issues.</p>
              <Button variant="outline" className="bg-white text-orange-600 border-orange-600 hover:bg-orange-50">
                Call Emergency Line
              </Button>
            </div>
          </div>
